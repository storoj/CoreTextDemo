...
@interface RenderedText2Line : NSObject
...
@implementation RenderedText2Line
...
@interface RenderedText2 ()
@property (nonatomic, strong) NSArray <RenderedText2Line *> *lines;
@end

@implementation RenderedText2
...
#define TRUNCATION_ENABLED 1
        ...
        [lines addObject:[RenderedText2Line line:line origin:CGPointMake(0, size.height-descent-leading)]];
    ...
    RenderedText2 *r = [[self alloc] init];
    r->_lines = lines;
    r->_size = size;
    r->_text = text;
...
- (void)drawInContext:(CGContextRef)ctx {
    ...
    for (RenderedText2Line *line in self.lines) {
